import { SlotCondition, SlotKind } from "../../data/model/Outfit.js";
...
function parse(str: string): SlotCondition[] {
	return str
		.split(',')
		.map(it => it.trim())
...
export class SlotConditionsModal extends SlotModal {
	...
	protected override isCloseOnBlur(): boolean {
		return false;
	}
	...
	private addConditionId(input: HTMLTextAreaElement, id: string): void {
